...
type RootStackParamList = {
    ...
    TransaccionExitoScreen: undefined;
};
...
type PuntosAcumuladosScreenNavigationProp = StackNavigationProp<RootStackParamList, 'TransaccionExitoScreen'>;
interface Props {
    navigation: PuntosAcumuladosScreenNavigationProp;
}
const TransferenciaPuntosScreen: React.FC<Props> = ({ navigation }) => {

    const handlePress = () => {
        navigation.navigate('TransaccionExitoScreen');
    };
...
export default TransferenciaPuntosScreen;
