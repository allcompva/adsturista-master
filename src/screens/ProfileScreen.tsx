...
const ProfileScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleLogout = async () => {
    try {
      ...
      if (isFakeUser) {
        // Para usuarios falsos, simplemente limpiamos el almacenamiento y el contexto
        await AsyncStorage.removeItem("@user");
        await AsyncStorage.removeItem("@formCompleted");
        setUser(null);
        Alert.alert("Sesión cerrada correctamente (modo falso)");
      } else {
        // Para usuarios reales, usamos el método normal de cierre de sesión
